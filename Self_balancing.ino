...
float Gyro_angle[2];
float Total_angle[2];
float elapsedTime, times, timePrev;
int i;
...
void setup() 
{
  Wire.begin(4,5); /////////////TO BEGIN I2C COMMUNICATIONS///////////////
  ...
  Serial.begin(9600);
  times = millis(); ///////////////STARTS COUNTING TIME IN MILLISECONDS/////////////
}
void loop() 
{
  /*////////////////////////WARNING//////////////////////
  ...
  */
    timePrev = times;  
    times = millis();  
    //elapsedTime = (times - timePrev) / 1000; 
    ...
    Serial.println("---------------------------");//////////UNCOMMENT FOR DDEBUGGING//////////////
    ///////////////SELF EXPLANATORY///////////////
    if(Total_angle[0]<0)
      {
       anti();
